...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://39jsof67kd.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'x-api-key', 'q', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var searchGetRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'x-api-key', 'Access-Control-Allow-Methods']),
